...
{
    /// <summary>
    /// Handle the References when user is adding a VRScrollBar script to a GameObject by implementing the IUISetupClickOnly interface.
    /// </summary>
	public class VRScrollbarSetup : IUISetupClickOnly
    {
        // EMPTY
